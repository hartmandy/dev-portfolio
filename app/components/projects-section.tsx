import { ExternalLinkIcon, GitHubLogoIcon, StarIcon, EnvelopeClosedIcon } from "@radix-ui/react-icons";
...
const projects: Project[] = [
  {
    ...
    description: "A delightful weather app that matches your mood to the forecast with animated backgrounds and personalized recommendations.",
    technologies: ["React", "TypeScript", "Weather API", "Framer Motion"],
    github: "https://github.com/hartmandy/weather-mood",
    demo: "https://weather-mood-app.vercel.app",
    featured: true,
    emoji: "🌤️",
    image: "/example.jpg",
  ...
  {
    title: "Recipe Finder",
    description: "Smart recipe discovery app with dietary filters, meal planning, and grocery list generation.",
  ...
  },
  {
    ...
    description: "Developer tool for organizing, searching, and sharing code snippets with syntax highlighting and tagging.",
  ...
  {
    title: "Habit Tracker",
    description: "Minimalist habit tracking app with streak counters, progress visualization, and motivational insights.",
    ...
    <section className="mt-20 ml-10 mr-10 max-w-7xl">
      <div className="mb-16 text-right">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 text-lg">
          Things I've built for fun, learning, and to solve interesting problems.
        </p>
      </div>
